...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" type="text/css" href="crud/adam.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="nav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <?php } ?>
        ...
        <li class="nav-item">
          <form method="post">
            <img src="crud/<?= $row['image_path']; ?>" alt="Profile Photo" height="35" width="35" id="img">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" id="drop" aria-labelledby="navbarDropdownMenuLink">
          <?php echo "<a class=\"dropdown-item text-light\" id=\"drop-item\" href=\"crud/edit_profile.php?id=".$row['user_id']."\">Edit Profile</a>"?>
        </div>
      </li>
