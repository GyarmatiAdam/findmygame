...
<main class="container">
  ...
  <div class="mt-5 row">
    <input class="col-5 offset-7" id="search" type="text" autocomplete="off" placeholder="Search Event..." name="name"/>
  </div>
  ...
  <hr>
                ...
                while($row = $result->fetch_assoc()) {
                   echo  "
                       		<div class=\"mt-4 col-3 ml-1 shadow-lg\"> 
              								<img id=\"pic\" class=\"card-img-top\" src=\"".$row['event_pic']."\" height=\"143.44\">
   ...
   <legend id="title-legend">Add an Event</legend>
   ...
   <form class="row d-flex justify-content-center" id="form">
          ...
          <input class="col-11" id="input" type="text" name="name" placeholder="Event Name">

          <input class="col-11 mt-3" id="input" type="text" name= "type" placeholder="Type of Event">

          <textarea class="col-11 mt-3" id="area" type="text" name= "desc" placeholder="Description"></textarea>

          <input class="col-11 mt-3" id="input" type="text" name= "date" placeholder="Date">

          <input class="col-11 mt-3" id="input" type="text" name= "location" placeholder="Location">

          <input class="col-11 mt-3" type="text" name="pic" id="input" placeholder="Link of the image">
          
          <button class="col-3 mt-3 btn btn-primary" type ="submit">Insert Event</button>
...
<script>
  ...
  $('#form').submit(function(event){
     ...
     var serializedData = $form.serialize();
       ...
       request = $.ajax({
       url: "crud/actions/events_create.php",
       type: "post",
       data: serializedData
   });
  ...
  $("#search").keyup(function(event){
   ...
   request1 = $.ajax({
       url: "crud/actions/events_search.php",
       type: "post",
       data: serializedData
   });
