...
<fieldset class="col-5" id="legend">
   <legend id="legend-title">Edit Group</legend>



   <form class="row d-flex justify-content-center" id="form">
       
          <input class="col-11" id="input" type="text" name="name" placeholder="Group Name" value="<?= $data['group_name']?>">

          <textarea class="col-11" id="area" type="text" name= "desc" placeholder="Description"><?= $data['group_desc']?></textarea>

          <input class="col-11" id="input" type="text" name= "vacancy_number" placeholder="Vacancy Number" value="<?= $data['vacancy_number']?>">

          <textarea class="col-11" id="area" type="text" name= "vacancy_desc" placeholder="Vacancy Description"><?= $data['vacancy_desc']?></textarea>

          <input class="col-11 mt-3" type="text" name="pic" id="input" placeholder="Link of the image" value="<?= $data['groups_pic']?>">
          
          <button class="col-3 btn btn-primary mb-9" id="input1" type ="submit">Edit Group</button>
  ...
  $('#form').submit(function(event){
     ...
     var serializedData = $form.serialize();
      ...
      request.done(function (response, textStatus, jqXHR){
                ...
                Swal.fire(
                  "Edited!",
                  "Your changes for the \"<?= $data['group_name']?>\" group are saved in the Database",
                  "success"
            );
